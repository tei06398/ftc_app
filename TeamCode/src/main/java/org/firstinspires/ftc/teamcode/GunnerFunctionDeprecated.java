...
public class GunnerFunctionDeprecated {
    ...
    private static final double JEWELPUSHER_SERVO_DOWN_POS = 0; //Set this value so it would compile without errors
    ...
    GunnerFunctionDeprecated(HardwareMap hardwareMap, Telemetry telemetry) {
